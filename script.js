...
function addBook(event) {
  ...
  const isCompleteChackBoc = document.querySelector("#inputBookIsComplete");

  //Mengonversi variabel yearInput dari int ke metode number
  ...
  authorInput.value = "";
  yearInput.value = "";
  isCompleteChackBoc.checked = false;
}
...
function displayBooks(booksToShow) {
  ...
  for (const book of booksToShow) {
    ...
    actionContainer.appendChild(actionContainer);
...
window.addEventListener("load", () => {
  ...
  searchBookForm.addEventListener("submit", addBook);
